...
<head>
    ...
    <title>Edit Siswa - <?php echo htmlspecialchars($siswa['nama']); ?></title>
    <!-- CSS -->
    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1"><i class="bi bi-pencil-square me-2"></i> Edit Data Siswa</h2>
                    <p class="text-muted mb-0">Formulir edit data siswa SD Lamaholot</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nis" name="nis"
                                       value="<?php echo htmlspecialchars($siswa['nis']); ?>" required placeholder="Masukkan NIS siswa">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama"
                                       value="<?php echo htmlspecialchars($siswa['nama']); ?>" required placeholder="Masukkan nama lengkap siswa">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="kelas" name="kelas"
                                       value="<?php echo htmlspecialchars($siswa['kelas']); ?>" placeholder="Masukkan kelas siswa">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="jurusan" name="jurusan"
                                       value="<?php echo htmlspecialchars($siswa['jurusan'] ?? ''); ?>" placeholder="Masukkan jurusan siswa">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="username" name="username"
                                       value="<?php echo htmlspecialchars($siswa['username']); ?>" required placeholder="Masukkan username unik">
                            </div>
                        </div>
                        <div class="mb-3">
