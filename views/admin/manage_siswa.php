    ...
    <style>
        ...
        * {
        ...
        .siswa-item {
            ...
            margin-bottom: 1rem;
            box-shadow: var(--shadow);
            border-left: 4px solid var(--ntt-secondary);
        }
    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1">Kelola Data Siswa</h2>
                    <p class="text-muted mb-0">Manajemen data siswa SD Lamaholot</p>
                </div>
            </div>
        </div>

        <div class="action-buttons">
            <a href="add_siswa.php" class="btn btn-add d-flex align-items-center justify-content-center">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="siswaTable" class="table table-hover">
                            <thead>
                                <tr>
                                    <th><i class="bi bi-person-vcard"></i> NIS</th>
                                    <th><i class="bi bi-person-fill"></i> Nama Lengkap</th>
                                    <th><i class="bi bi-door-open"></i> Kelas</th>
                                    <th><i class="bi bi-journal-text"></i> Jurusan</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action-cell">
                                        <a href="edit_siswa.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-warning action-btn">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>
                                        <a href="../../actions/crud_siswa.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger action-btn" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
        ...
        <div class="mobile-card">
            ...
            <div class="siswa-item">
                <div class="siswa-header">
                    <div class="siswa-name"><?php echo htmlspecialchars($row['nama']); ?></div>
                </div>
                <div class="siswa-details">
                    <div class="detail-item">
                        <span class="detail-label">NIS</span>
                        <span class="detail-value"><?php echo htmlspecialchars($row['nis']); ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Kelas</span>
                        <span class="detail-value"><?php echo htmlspecialchars($row['kelas']); ?></span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Jurusan</span>
                        <span class="detail-value"><?php echo htmlspecialchars($row['jurusan']); ?></span>
                    </div>
                    <div class="detail-item">
                ...
                <div class="mobile-actions">
                    ...
                    <a href="../../actions/crud_siswa.php?action=delete&id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?');">
                        <i class="bi bi-trash"></i> Hapus
                    </a>
                </div>
            </div>
