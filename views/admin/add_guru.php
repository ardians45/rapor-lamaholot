...
<head>
    ...
    <title>Tambah Guru - SD Lamaholot</title>
    ...
    <main class="lg:ml-64 min-h-screen flex flex-col">
        ...
        <header class="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 px-4 lg:px-8 flex items-center justify-between">
            <div class="flex items-center">
                <a href="manage_guru.php" class="mr-4 text-slate-400 hover:text-slate-600 lg:hidden">
                    <i class="ph ph-arrow-left text-2xl"></i>
                </a>
                <h1 class="text-xl font-bold text-slate-800">Tambah Guru</h1>
            </div>
        </header>
        ...
        <div class="p-4 lg:p-8 max-w-3xl mx-auto w-full">
            ...
            <form action="../../actions/crud_guru.php?action=create" method="POST" class="space-y-8">
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="font-bold text-slate-800">Identitas Guru</h3>
                            <p class="text-sm text-slate-500">Informasi dasar data guru.</p>
                        </div>
                    </div>
                    <div class="p-6 space-y-6">
                        <div class="space-y-2">
                            <label for="nip" class="text-sm font-semibold text-slate-700">NIP (Nomor Induk Pegawai)</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                                    <i class="ph ph-identification-card text-lg"></i>
                                </div>
                                <input type="text" id="nip" name="nip" required 
                                    class="block w-full pl-10 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all"
                    ...
                    <div class="p-6 space-y-6">
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-slate-500 flex items-center mt-1">
                                <i class="ph-fill ph-info mr-1"></i> Disarankan menggunakan NIP sebagai username.
                            </p>
                        </div>
                ...
                <div class="flex items-center justify-end gap-4 pt-4">
                    <a href="manage_guru.php" class="px-6 py-2.5 rounded-xl text-slate-600 hover:bg-slate-100 font-medium transition-colors">
                        Batal
                    </a>
                    <button type="submit" class="px-8 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl shadow-lg shadow-primary-500/30 transition-all transform hover:-translate-y-0.5 flex items-center">
                        <i class="ph-bold ph-check-circle mr-2"></i> Simpan Data Guru
                    </button>
                </div>
