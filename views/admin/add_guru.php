    ...
    <div class="container-fluid">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-1"><i class="bi bi-person-plus-fill me-2"></i> Tambah Guru</h2>
                    <p class="text-muted mb-0">Formulir penambahan data guru SD Lamaholot</p>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body p-0">
                <form action="../../actions/crud_guru.php?action=create" method="POST">
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nip" name="nip" required placeholder="Masukkan NIP guru">
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" required placeholder="Masukkan nama lengkap guru">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Saran: gunakan NIP sebagai username agar unik.</div>
                        </div>
                        <div class="mb-3">
