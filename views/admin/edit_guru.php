...
<head>
    ...
    <title>Edit Guru - SD Lamaholot</title>
    ...
    <main class="lg:ml-64 min-h-screen flex flex-col">
        ...
        <header class="h-16 bg-white/80 backdrop-blur-md border-b border-slate-200 sticky top-0 z-30 px-4 lg:px-8 flex items-center justify-between">
            <div class="flex items-center">
                ...
                <h1 class="text-xl font-bold text-slate-800">Edit Data Guru</h1>
            </div>
        </header>
                ...
                <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                    <div class="p-6 border-b border-slate-100 bg-slate-50/50 flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-slate-500">Perbarui informasi data guru.</p>
                        </div>
                    </div>
                    ...
                    <div class="p-6 space-y-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($guru['username']); ?>" required 
                                    class="block w-full pl-10 pr-3 py-2.5 bg-white border border-slate-200 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-all">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-xs text-slate-500 flex items-center mt-1">
                                <i class="ph-fill ph-info mr-1"></i> Hanya isi jika ingin mereset password guru ini.
                            </p>
                        </div>
                    </div>
                </div>
